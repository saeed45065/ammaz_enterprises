      ...
      mainAxisAlignment: MainAxisAlignment.end,
       children: [
        customFloatingButton(
           ...
           doc(personName.text.toLowerCase()).set({"Name":personName.text}).then((value) {
    ...
    return  InkWell(
      ...
      child: Mycontainer(
            ...
            ,
             ...
             child: Center(child: MyText(text: buttonLabel,fontSize: textFont,color: const Color.fromARGB(255, 0, 0, 0),),),
           ),
    );
  }
